...
var speed,weight,state,thickness;
...
function damage(){
  let damage = Math.round((0.5 * weight * (speed * speed)) / (thickness*thickness*thickness));

  textAlign(CENTER);
  textSize(25);
  push(); //Starting a new drawing state
  fill(0);
  text("Wall damage :"+damage,windowWidth/2,100); //Displaying the deformation
  pop();
